...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.bg-c3
      .col-12
        .p-5
          p.mb-4 La Organización Mundial de la Salud (OMS) define la salud mental como:
          .row.mb-4
    ...
    p La salud debe concebirse de manera integral, considerando que los aspectos biológicos, psicológicos y sociales forman parte del bienestar y convergen constantemente. 
    p.mb-4 Ampliemos la información sobre cada uno de estos aspectos:
    ...
    .row.justify-content-center.mb-5
      .col-lg-10
        .titulo-sexto.color-acento-contenido.mb-3
          p.mb-0 #[b Figura 3.] Aspectos psicológicos
        .row
          .col-12
            .p-4.bg-c4
              figure
    ...
    .row.justify-content-center
      .col-lg-10
        .titulo-sexto.color-acento-contenido.mb-3
          p.mb-0 #[b Figura 4.] Aspectos sociales
        .row
          .col-12
            .p-4.bg-c4
              figure
